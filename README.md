# Streamdata.io GitHub Repositories Search Streaming to AWS S3 Data Lake (Serverless)
<img src="https://s3.amazonaws.com/kinlane-productions/streamdata/streamdata-logo-vertical-2.png" align="right" width="250" />This is a demo of delivering a stream of Github repositories searches using Streamdata.io running on AWS Lambda as a "serverless" function. It is designed to take this existing JSON API and turn it into a streaming API using Server-Sent Events (SSE), applying incremental updates using JSON Patch, and then stream the results into a data lake store on Amazon S3.
...
- [AWS Serverless Application Repository](https://serverlessrepo.aws.amazon.com/#/applications/arn:aws:serverlessrepo:us-east-1:879370021840:applications~StreamData-IO-Github-Search-Repositories)
- [License: MIT License](https://github.com/streamdata-serverless/streamdata-io-github-repositoriess-search/blob/master/LICENSE)
...
- Where do I get support for this function? Submit your repositoriess via [the Github repository for this project](https://github.com/streamdata-serverless/streamdata-io-github-repositoriess-search/repositoriess)
